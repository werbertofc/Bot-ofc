// index.js - BotOfc (WHATSAPP + RECONEXÃO + ANTI-BAN + MENU COM IMAGEM)
...
const startBot = () => {
  ...
  sock.ev.on("messages.upsert", async ({ messages }) => {
    ...
    // === MENU COM IMAGEM (FORA DO ARQUIVO) ===
    if (cmd === "menu") {
      const { enviarMenu } = await import('./menu.js');
      return enviarMenu(sock, from);
    }
